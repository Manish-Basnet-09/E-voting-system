...
class User(Base):
    ...
    # Tracks the live active unique login instance token across devices (Clash of Clans kick)
    current_session_token = Column(String(255), nullable=True)
    
    # Stores the short-lived 6-digit identity validation code sent via SMTP mail right before voting
